...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
  <legend>添加<?php echo ($type); ?></legend>
</fieldset>
 
<form class="layui-form" action="<?php echo U('Rbac/addNode');?>" method="post">
  ...
  <div class="layui-form-item">
    <div class="layui-input-block">
      <input type="radio" name="status" value="1" title="启用<?php echo ($type); ?>" checked="">
      <input type="radio" name="status" value="0" title="关闭<?php echo ($type); ?>">
    </div>
  </div>
